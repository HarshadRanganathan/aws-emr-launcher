...
class EmrLauncher(object):
    ...
    def create_cluster(self, flow_config, cluster_config, region):
        ...
        response = self.client.run_job_flow(
            ...
            JobFlowRole=flow_config.get(region).get(self.JOB_FLOW_ROLE, self.EMR_JOB_FLOW_DEFAULT),
    ...
    @staticmethod
    def _step_definition(step_name, action_on_failure, args):
        """
    ...
    def add_step(self, step_name, action_on_failure, args):
        """
